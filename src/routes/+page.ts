...
export const load: PageLoad = async ({ fetch, parent }) => {
	...
	const yourFaveArtists = fetch(`api/spotify/me/top/artists`);
	...
	return {
		...
		userPlaylists: userPlaylistsRes.ok
			...
			: undefined,
		yourFaveArtists: yourFaveArtistsRes.ok
			? (yourFaveArtistsRes.json() as Promise<SpotifyApi.UsersTopArtistsResponse>)
			: undefined,
		homeCategores: randomCats,
